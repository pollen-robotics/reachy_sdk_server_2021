...
class ReachySDKServer(Node,
    ...
    def __init__(self, node_name: str, timeout_sec: float = 5, pub_frequency: float = 100) -> None:
        ...
        while not self.mobile_platform_mode_srv.wait_for_service(timeout_sec=1.0):
            self.get_logger().info(f'service {self.mobile_platform_mode_srv.srv_name} not available, waiting again...')
